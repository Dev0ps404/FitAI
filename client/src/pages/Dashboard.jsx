    ...
    <section className="subtle-fade-in space-y-8 py-8 md:py-12">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <article className="panel-card relative overflow-hidden">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-blue-600 to-blue-400" />
          <p className="text-xs uppercase tracking-[0.14em] text-blue-200/70">
            Current Weight
          </p>
        ...
        <article className="panel-card relative overflow-hidden">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-cyan-500 to-blue-400" />
          <p className="text-xs uppercase tracking-[0.14em] text-blue-200/70">
            Today&apos;s Workout
          </p>
            ...
            <div className="mt-5 h-56 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={progressTimeline}>
                  ...
                  <XAxis dataKey="date" stroke="#bfdbfe" fontSize={11} />
                  <YAxis stroke="#bfdbfe" fontSize={11} />
                  <Tooltip
                    contentStyle={{
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        >
          <h2 className="font-heading text-lg font-semibold uppercase tracking-[0.06em] text-blue-100">
            Workout Tracker
          </h2>
          <p className="mt-2 text-sm text-blue-100/75">
      ...
      <article className="panel-card">
        ...
        {sessionFeedback ? (
          <p className="mt-4 rounded-xl border border-blue-300/35 bg-blue-500/15 px-4 py-3 text-sm text-blue-100">
            {sessionFeedback}
          </p>
        ) : null}
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  {session.isCurrent ? (
                    <span className="rounded-full border border-blue-300/50 bg-blue-500/20 px-3 py-1 text-xs uppercase tracking-[0.14em] text-blue-100">
                      Current
                    </span>
                  ) : (
                    <button
